...
package net.david.bluemoon.world.dimension;
...
public class BluedimensionDimension {
	@Mod.EventBusSubscriber(bus = Mod.EventBusSubscriber.Bus.MOD)
	public static class BluedimensionSpecialEffectsHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public static void registerDimensionSpecialEffects(RegisterDimensionSpecialEffectsEvent event) {
			...
			event.register(new ResourceLocation("bluemoon:bluedimension"), customEffect);
		}
	}
}
